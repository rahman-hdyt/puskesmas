    ...
    <div class="row justify-content-center">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 col-sm-6">
                <div class="widget mb-5 mb-lg-0">
                    ...
                    <p>Jl. Kesehatan Nomor 41 Sekura, Kec. Teluk Keramat, Kab. Sambas, Provinsi Kalimantan Barat 79465</p>
                </div>
            </div>
        ...
        <div class="footer-btm py-4 mt-5">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6">
                    <div class="copyright">
                        Copyright &copy; 2021, Copyright Puskesmas. All Rights Reserved.
                    </div>
                </div>
                <div class="col-lg-6">
